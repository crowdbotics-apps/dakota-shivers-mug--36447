...
## Project Structure
    ...
    ├── dakota_shivers_mug__36447  # Django project configurations
...
1. Clone this repo and `cd dakota_shivers_mug__36447`
...
2. Clone this repo and `cd dakota_shivers_mug__36447`
